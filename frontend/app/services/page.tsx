...
// import { IPackage } from "@/redux/types"; // Adjust the import path to match your project structure
...
//     setFormErrors({ ...formErrors, [e.target.name]: null }); // Reset error when user types
//   };
...
//       errors.name = "Service name can't be empty.";
//     }
...
//               className="border p-2 rounded mb-2 md:mb-0 w-full"
//               required
//             />
//             {formErrors.name && (
